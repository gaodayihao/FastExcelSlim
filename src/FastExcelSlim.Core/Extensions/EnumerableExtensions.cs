...
{
    public static void SaveToExcel<T>(this IEnumerable<T> values, Stream stream, OpenXmlStyles? styles = null)
    {
    ...
    public static void SaveToExcel<T>(this IEnumerable<T> values, string path, OpenXmlStyles? styles = null)
    {
